...
-->
<html ng-app="boilerplate" ng-controller="AppCtrl">
  <head>
    <meta charset="utf-8">
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo asset('bower_components/AdminLTE/dist/css/AdminLTE.css');?>">
    <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
          page. However, you can choose any other skin. Make sure you
          apply the skin class to the body tag so the changes take effect.
    -->
    <link rel="stylesheet" href="<?php echo asset('bower_components/AdminLTE/dist/css/skins/skin-black-light.min.css');?>">

    <!-- inject:css -->
    <link rel="stylesheet" href="<?php echo asset('app/css/app.css');?>">
    <link rel="stylesheet" href="<?php echo asset('app/css/sidebar-style.css');?>">
    <!-- endinject -->
  ...
  <body class="hold-transition skin-black-light sidebar-mini fixed">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="fa {{ app.user.messages.length ? 'fa-envelope text-teal' : 'fa-envelope-o' }}"></i>
                  <span class="label label-success">{{ app.user.messages.length }}</span>
                </a>
                <ul class="dropdown-menu">
                  <li class="header">You have {{ app.user.messages.length }} messages</li>
                  <li>
                    <!-- inner menu: contains the messages -->
                    <ul class="menu">
                      <li ng-repeat="message in app.user.messages"><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <!-- User Image -->
              ...
              <li class="dropdown notifications-menu">
                <!-- Menu toggle button -->
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="fa {{ app.user.notifications.length ? 'fa-bell text-red' : 'fa-bell-o' }}"></i>
                  <span class="label label-warning">{{ app.user.notifications.length }}</span>
                </a>
                <ul class="dropdown-menu">
                  <li class="header">You have {{ app.user.notifications.length }} notifications</li>
                  <li>
                    <!-- Inner Menu: contains the notifications -->
                    <ul class="menu">
                      <li ng-repeat="notification in app.user.notifications"><!-- start notification -->
                        <a href="#">
                          <i class="fa {{ notification.icon }}"></i> {{ notification.content }}
                        </a>
                      </li><!-- end notification -->
                    </ul>
                  </li>
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img ng-src="{{ app.user.avatar }}" class="user-image" alt="User Image">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="<?php echo asset('bower_components/AdminLTE/dist/img/user2-160x160.jpg');?>" class="img-circle" alt="User Image">
                    <p>
                      {{ app.user.fullname }}
                      <small>{{ app.user.title }}</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong><!-- Copyright &copy; 2015 <a href="#">Company</a>.</strong> All rights reserved. --></strong>
      </footer>
    </div><!-- ./wrapper -->
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo asset('bower_components/AdminLTE/dist/js/app.min.js');?>"></script>
    <script src="<?php echo asset('bower_components/AdminLTE/plugins/slimScroll/jquery.slimscroll.min.js');?>"></script>
